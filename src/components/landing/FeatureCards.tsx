...
function FeatureCards() {
  return (
    <section className="py-20 bg-blue-50/50 dark:bg-gray-900/50 transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full bg-blue-100 dark:bg-blue-900/50 px-4 py-1.5 text-sm text-blue-800 dark:text-blue-300 border border-blue-200/50 dark:border-blue-700/50 mb-4">
        ...
        >
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group relative rounded-2xl bg-white dark:bg-gray-800 p-6 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300"
            >
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-blue-50/50 to-white dark:from-gray-700/30 dark:to-gray-800 opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10" />
